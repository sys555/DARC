...
mock_PM_query = """作为产品经理，如果团队需要创建一个整数加法函数，我的任务是确保这个功能满足用户的需求，并且与开发团队沟通这个需求的具体细节。下面是我会采取的步骤：
...
通过上述步骤，我作为产品经理将确保整数加法函数不仅能够满足用户的基本需求，而且具有良好的用户体验和可靠性。同时，我还会确保产品的持续改进和优化，以适应市场和用户的变化需求。"""
