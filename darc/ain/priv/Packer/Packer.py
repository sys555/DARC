...
def compute(input: bytes) -> str:
    ...
    command = [
        "python",
        "/Users/mac/Documents/pjlab/repo/CodeS/validation/evaluation_scripts/transfer_output_to_repo.py",
        "--project", repo_name,
        "--input_dir", "/Users/mac/Documents/pjlab/repo/LLMSafetyChallenge/darc/ain/eval_data/jsonl",
        "--output_dir", "/Users/mac/Documents/pjlab/repo/LLMSafetyChallenge/darc/ain/eval_data/repo/"
    ]
