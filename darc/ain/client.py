...
def run():
    ...
    with grpc.insecure_channel('localhost:50051') as channel:
        ...
        update_actor_request = masrpc_pb2.UpdateActorRequest(actor_uid="uid")
        update_actor_response = stub.UpdateActor(update_actor_request)
        print("update response:", update_actor_response.status)
